...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
    <div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <div style="padding: 20px; text-align: center;">
            ...
            <p style="font-size: 16px; color: #333333; margin-bottom: 20px;">We received a request to reset your password. Click the button below to reset it. This link will be valid for a day.</p>
        ...
        <div style="margin-top: 20px; padding: 10px; font-size: 12px; color: #777777; text-align: center;">
            ...
            <p>&copy; 2024 AIC. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
